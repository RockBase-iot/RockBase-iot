...
**Rockbase Technology** (Chengdu, China) is dedicated to making industrial IoT **stable, secure, and scalable**. 
...
🔗 **Community**: [r/rockbaseiot](https://www.reddit.com/r/rockbaseiot/)
...
To bridge the gap between industrial IoT complexity and developer accessibility through:
- **Open-source hardware designs** (NM-CYD-C5, NM-RF-HAT, NM-Display-28inch)
- **Collaborative firmware development** (BruceDevices, Marauder and other projects support)
- **Community-driven innovation** on [r/rockbaseiot](https://www.reddit.com/r/rockbaseiot/)
